...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class GoogleLibraryAccessors extends SubDependencyFactory {
        ...
        private final GoogleDriveLibraryAccessors laccForGoogleDriveLibraryAccessors = new GoogleDriveLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>google.drive</b>
         */
        public GoogleDriveLibraryAccessors getDrive() {
            return laccForGoogleDriveLibraryAccessors;
        }
    ...
    public static class GoogleApiClientLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>googleApiClient</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("google.api.client");
        }
    ...
    public static class GoogleDriveLibraryAccessors extends SubDependencyFactory {

        public GoogleDriveLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>api</b> with <b>com.google.api-services:drive</b> coordinates and
         * with version reference <b>googleDriveApi</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getApi() {
            return create("google.drive.api");
        }
    ...
    public static class GoogleHttpClientLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>googleHttpClientGson</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getGson() {
            return create("google.http.client.gson");
        }
    ...
    public static class KotlinxCoroutinesLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>coroutinesAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>coroutinesAndroid</b> with value <b>1.7.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCoroutinesAndroid() { return getVersion("coroutinesAndroid"); }
        ...
        /**
         * Version alias <b>googleApiClient</b> with value <b>1.32.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGoogleApiClient() { return getVersion("googleApiClient"); }

        /**
         * Version alias <b>googleApiClientAndroid</b> with value <b>1.33.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>googleDriveApi</b> with value <b>v3-rev197-1.25.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGoogleDriveApi() { return getVersion("googleDriveApi"); }

        /**
         * Version alias <b>googleHttpClientGson</b> with value <b>1.43.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGoogleHttpClientGson() { return getVersion("googleHttpClientGson"); }
        ...
        /**
         * Version alias <b>serializationJson</b> with value <b>1.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
